...
class LoginForm(FlaskForm):
    email_address = EmailField("", validators=[InputRequired(), Email()], render_kw={"placeholder": "Email Address", "class": "form-control"})
...
class RegisterForm(FlaskForm):
    ...
    email_address = EmailField("Email:", validators=[InputRequired(), Email()], render_kw={"placeholder": "Email Address", "class": "form-control"})
    ...
    #     min=1, max=30)], render_kw={"placeholder": "User Name"})
    phone_number = StringField("Phone No. :", validators=[Length(min=1, max=15)], render_kw={"placeholder": "Phone Number"})
    ...
    password = PasswordField("Password:", validators=[InputRequired(), Length(min=1, max=50)], render_kw={"placeholder": "Password"})
    confirm_password = PasswordField("Confirm Password:", validators=[InputRequired(), Length(min=1, max=50)], render_kw={"placeholder": "Confirm Password"})
